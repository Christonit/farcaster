  ...
  return (
    <div className='overflow-x-hidden'>
      ...
      <section className='bg-white py-[64px] relative' id='hero-banner'>
        ...
        <div className='container lg:container mx-auto mt-[32px] lg:mt-[124px] relative z-[2]'>
          <div className='flex flex-col px-5'>
            {/* <p className='self-center  leading-5 text-zinc-500 max-md:max-w-full white-shadow'>
              This is supposed to be a fucking looped carousel. We've
              transformed the financial journey for countless teams
            </p> */}
            <section className='py-12  w-full rounded-3xl bg-slate-900 px-[20px] max-md:max-w-full'>
      ...
      <Container>
        <div className='flex flex-col lg:grid grid-cols-2 lg:flex-nowrap xl:flex-row gap-[32px] lg:gap-[64px] items-center justify-center lg:px-[24px]'>
          <figure className='advert-image'>
            <img
              loading='lazy'
              src='https://pbs.twimg.com/media/GI67ga7WUAEh45H?format=jpg&name=4096x4096'
          ...
          <div className='block flex flex-col gap-[32px] lg:gap-[16px] text-left max-w-[760px]'>
            ...
            <div className='rounded-[8px] border-[2px] border-slate-200  px-[16px] py-[16px]'>
              <b className='text-xl'>Immutable Supply Chain Tracking</b>
              <p>
      ...
      <Container>
        <div className='flex flex-col lg:grid grid-cols-2 lg:flex-nowrap xl:flex-row gap-[32px] items-center justify-center lg:px-[24px]'>
          <div className='block flex flex-col gap-[32px] lg:gap-[16px] text-left max-w-[560px]'>
            <h3 className='text-2xl lg:text-4xl font-semibold'>
              Empowering Tomorrow's Innovations with Ljubljana Blockchain
            </h3>
          ...
          <div className='flex gap-[32px] md:flex-nowrap flex-wrap'>
              ...
              <div className='flex flex-col grow items-start'>
                ...
                >
                  <g clipPath='url(#clip0_72_2888)'>
                    <path
                      d='M1.875 39.375L17.1464 42.4293C19.098 42.8196 20.4048 44.6665 20.1233 46.6368L17.335 66.1553C17.071 68.0028 15.4888 69.375 13.6226 69.375H1.875V39.375Z'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M20.625 46.875C20.625 46.875 25.9375 45 31.875 45C37.8125 45 41.2092 49.095 48.75 50.625C56.8359 52.2656 61.875 54.1406 61.875 58.125C61.875 62.1094 55.7812 64.1016 35.625 58.125'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M61.875 60C61.875 60 74.0625 56.25 78.75 56.25C83.4375 56.25 88.125 58.125 88.125 61.875C81.7187 64.6875 59.375 76.875 50.625 76.875C41.875 76.875 18.75 65.625 18.75 65.625'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M69.375 35.625C75.5882 35.625 80.625 30.5882 80.625 24.375C80.625 18.1618 75.5882 13.125 69.375 13.125C63.1618 13.125 58.125 18.1618 58.125 24.375C58.125 30.5882 63.1618 35.625 69.375 35.625Z'
                      stroke='#0152ff'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M58.7931 20.6923C58.5677 20.6788 58.3539 20.625 58.125 20.625C51.9118 20.625 46.875 25.6618 46.875 31.875C46.875 38.0882 51.9118 43.125 58.125 43.125C63.0409 43.125 67.1759 39.9518 68.7069 35.5577'
                      stroke='#0152ff'
                      strokeWidth='3.86866'
                    />
                  </g>
            ...
            <div className='flex flex-col ml-5 w-3/12 max-md:ml-0 max-md:w-full'>
              <div className='flex flex-col grow'>
                ...
                >
                  <path
                    d='M47.5 76.6459C64.7014 76.6459 78.6458 62.7014 78.6458 45.5C78.6458 28.2987 64.7014 14.3542 47.5 14.3542C30.2986 14.3542 16.3542 28.2987 16.3542 45.5C16.3542 62.7014 30.2986 76.6459 47.5 76.6459Z'
                    stroke='#0D0D0D'
                    strokeWidth='3.86866'
                  />
                  <path
                    d='M16.3542 44.1459C22.1094 44.1459 22.6454 49.0829 24.4792 50.9167C26.3129 52.7505 29.8958 51.1424 29.8958 53.625C29.8958 56.1077 27.1875 57.1797 27.1875 60.3959C27.1875 63.612 27.1875 69.1173 27.1875 69.1173'
                    stroke='#0D0D0D'
                    strokeWidth='3.86866'
                  />
                  <path
                    d='M76.247 33.4939C76.247 33.4939 70.7959 40.3584 69.1667 38.7292C67.5374 37.0999 63.8346 35.1745 65.1042 38.7292C66.3737 42.2839 70.5208 45.5 70.5208 45.5C70.5208 45.5 66.4583 49.9857 66.4583 52.2708C66.4583 54.556 63.75 54.0059 63.75 57.6875C63.75 61.3692 56.9792 63.1042 56.9792 63.1042C56.9792 63.1042 54.2708 60.0996 54.2708 57.6875C54.2708 55.2754 55.625 55.8255 55.625 53.625C55.625 51.4245 54.2708 50.6205 54.2708 48.2083C54.2708 45.7962 46.696 45.5 44.7917 45.5C42.8874 45.5 40.7292 44.6537 40.7292 42.7917C40.7292 40.9297 39.8616 38.2425 42.0833 36.0208C44.305 33.7992 47.8385 33.3125 50.2083 33.3125C53.8476 33.3125 52.832 34.6667 56.9792 34.6667C61.1263 34.6667 65.1042 35.2168 65.1042 31.9583C65.1042 28.6999 58.5026 27.8958 54.2708 27.8958C50.039 27.8958 48.1348 30.6042 44.7917 30.6042C42.972 28.7845 45.8496 25.3568 48.8542 23.8333C51.8587 22.3099 51.7295 21.125 50.2083 19.7708C52.1338 17.8454 60.785 17.3221 60.785 17.3221'
                    stroke='#0D0D0D'
                    strokeWidth='3.86866'
                  />
                  <path
                    d='M91.9658 14.8561L87.6804 23.4269L79.1096 19.1415'
                    stroke='#0152ff'
                    strokeWidth='3.86866'
                  />
                  <path
                    d='M66.2535 2C78.0884 2.03771 86.2074 12.1778 87.6804 23.4269'
                    stroke='#0152ff'
                    strokeWidth='3.86866'
                  />
                  <path
                    d='M2 79.1231L6.28537 70.5523L14.8561 74.8377'
                    stroke='#0152ff'
                    strokeWidth='3.86866'
                  />
                  <path
                    d='M27.7122 91.9792C15.8773 91.9415 7.75827 81.8014 6.28534 70.5523'
                    stroke='#0152ff'
                    strokeWidth='3.86866'
                  />
                </svg>
              ...
              <div className='flex flex-col grow'>
                ...
                >
                  <g clipPath='url(#clip0_72_2935)'>
                    <path
                      d='M58.2172 50.625H7.5C4.3934 50.625 1.875 48.1066 1.875 45V26.25C1.875 23.1434 4.3934 20.625 7.5 20.625H75C78.1066 20.625 80.625 23.1434 80.625 26.25V34.3207'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M41.0613 27.4713V43.7787'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M48.1226 31.5482L34 39.7018'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M34 31.5482L48.1226 39.7018'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M18.0613 27.4713V43.7787'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M25.1226 31.5482L11 39.7018'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M11 31.5482L25.1226 39.7018'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M73.125 69.375C86.25 63.2609 88.125 59.0829 88.125 46.5489V36.7663L73.125 31.875L58.125 36.7663V46.5489C58.125 59.0829 60 63.2609 73.125 69.375Z'
                      stroke='#0152ff'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M80.625 50.625C80.3613 56.0372 79.0288 58.0112 73.125 61.0405V50.6254L80.625 50.625Z'
                      stroke='#0152ff'
                      strokeWidth='3.86866'
                      strokeLinejoin='round'
                    />
                    <path
                      d='M65.625 50.625V42.2095L73.125 39.7632V50.6254L65.625 50.625Z'
                      stroke='#0152ff'
                      strokeWidth='3.86866'
                      strokeLinejoin='round'
                    />
              ...
              <div className='flex flex-col grow pb-5'>
                ...
                >
                  <g clipPath='url(#clip0_72_2975)'>
                    <path
                      d='M36.9 50.5667H61.5'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M20.5 17.7667H42.3667'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M20.5 34.1666H61.5'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M20.5 42.3666H61.5'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M20.5 25.9666H61.5'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                    <path
                    ...
                    />
                    <path
                      d='M12.3 5.46664V76.5333C12.3 78.7977 14.1356 80.6333 16.4 80.6333H65.6C67.8644 80.6333 69.7 78.7977 69.7 76.5333V17.7666L53.3 1.36664H16.4C14.1356 1.36664 12.3 3.20227 12.3 5.46664Z'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                    <path
                      d='M53.3 1.36664V13.6666C53.3 15.931 55.1356 17.7666 57.4 17.7666H69.7'
                      stroke='#0D0D0D'
                      strokeWidth='3.86866'
                    />
                  </g>
